...
public class Intro extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .description("Get real time notification updates where ever there is a change in buses or routes")
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .description("Missed the bus? Get current bus location with a single push")
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .description("Full route map of bus with boarding point indicators, along with live traffic")
